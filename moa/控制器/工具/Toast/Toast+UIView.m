...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    wrapperView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:CSToastOpacity - 0.2];
    ...
    if (title != nil) {
        ...
        CGRect expectedRectTitle = [title boundingRectWithSize:maxSizeTitle options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil];
        titleLabel.frame = CGRectMake(0.0, 0.0, expectedRectTitle.size.width, expectedRectTitle.size.height);
