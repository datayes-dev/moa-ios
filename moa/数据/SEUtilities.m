...
+ (NSString*)translateDate:(double)publishTime
{
    NSDate *date = [NSDate dateWithTimeIntervalSince1970: publishTime/1000];
    ...
    NSDateComponents* timerComponents = [calendar components:NSCalendarUnitYear|NSCalendarUnitMonth|NSCalendarUnitDay fromDate:date];
    NSInteger years = [nowComponents year] - [timerComponents year];
    NSInteger months = [nowComponents month] - [timerComponents month];
    NSInteger days = [nowComponents day] - [timerComponents day];
